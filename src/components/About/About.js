        ...
        <div>
            ...
            <div className="row my-4">
                <div className="col-12 col-md-6">
                    <img className="w-100 m-4" src="https://roam.qodeinteractive.com/wp-content/uploads/2017/08/about-1-img-1.jpg" alt="" />
                </div>
            ...
            <div className="row my-4">
                <div className="col-12 col-md-6">
                    <img className="w-75 m-4 bg-danger" src="https://roam.qodeinteractive.com/wp-content/uploads/2017/08/h3-img-1.png" alt="" />
                </div>
                <div className="col-12 col-md-6 px-3">
